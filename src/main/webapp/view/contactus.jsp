...
<title>Contact Us|DSP IT WORLD</title>
</head>
<body>
            ...
            <div class="contact_information">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 mx-auto wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                      ...
                      <a href="mailto:dspsable007@gmail.com">
                        ...
                        <div class="contact_text">
                            ...
                            <a href="mailto:dspsable007@gmail.com" class="text-dark mt-lg-2">Email: dspsable007@gmail.com</a>
                        </div>
                    </div>
                      </a>
                    </div>
                    <div class="col-md-6 col-lg-4 mx-auto wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                      <a target="_balnk" href="#">
                        <div class="contact_box text-center">
                            ...
                            <div class="contact_text">
                                <a target="_balnk" href="#" class="text-dark mt-lg-2">Location: H.No - 40 B, Beside Ganesh Temple, Audumber Colony, Pune - 411052</a>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-md-6 col-lg-4 mx-auto wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                      <a href="tel:+91 7038653479">
                        <div class="contact_box text-center">
                            <div class="contact_icon">
                            ...
                            <div class="contact_text">
                                <a href="tel:+91 7038653479" class="text-dark mt-lg-2">Phone: +91 7038653479</a>
                            </div>
                        </div>
                      </a>
                    </div>
