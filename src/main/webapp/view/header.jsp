<%@page import="com.dsp.model.StudentModel"%>
...
<meta charset="UTF-8">
    ...
    <title>DSP IT WORLD Training Institute.com|HomePage</title>
    ...
    <header id="home">
        <div style="background-color: lightgray; padding: 15px 0px; text-align:center;">
            <marquee behavior="" direction="">
              ...
              <span class="ph" style="max-width: 50px; height:10px">(<i class="fa-sharp fa-solid fa-phone"></i>)+91-7038653479</span>
            </marquee>
        </div>
    ...
    <div class="container">
        <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                        <div class="logo">
                          <a href="">
                           <img src="/images/dsp_no_background.png" alt="settings-logo" width="120px" class="lazyload" loading="lazy">
                            <span class="text-black">IT WORLD </span>
                          </a>
                        </div>
                    </div>
